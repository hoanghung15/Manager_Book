...
<!-- <body>
    <h2>Tìm kiếm sách theo Mã SP và cập nhật thông tin</h2>
    <form method="post">
        <label>Mã sách:</label>
        <input type="text" name="maSp" required>
        <input type="submit" value="Tìm kiếm" name="searchBook">
    </form>
    ...
    ?>
                <form method="post">
                    ...
                    <input type="text" name="theLoai" value="<?php echo $row['theLoai']; ?>"><br><br>

                    <label>Tác giả:</label>
                    <input type="text" name="tacGia" value="<?php echo $row['tacGia']; ?>"><br><br>

                    <label>Số lượng:</label>
                    <input type="number" name="soLuong" value="<?php echo $row['soLuong']; ?>"><br><br>

                    <input type="submit" value="Cập nhật" name="updateBook">
                </form>
    <?php
            } else {
                echo "<p>Không tìm thấy sách có mã SP '$maSp'.</p>";
            }
        }
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            if(isset($_POST['updateBook'])){
                ...
                $sql = "UPDATE tblbooks SET tenSP='$tenSp', theLoai='$theLoai', tacGia='$tacGia', soLuong='$soLuong' WHERE maSP='$maSp'";

                if ($conn->query($sql) === TRUE) {
                    echo "<p>Cập nhật thông tin sách thành công!</p>";
                } else {
...
<body class="bg-[#EAEDFE]">
            ...
            <div class=" rounded-[50px] w-[70%] h-full bg-white flex">
                <div class="w-full h-full">
                    <div class="px-[40px] mt-[40px]">
                        <p class="font-bold text-[#001C53] text-[40px]">UPDATE</p>
    ...
    ?>
                            <form method="post">
                                ...
                                <div class=" mt-[20px]">
                                    <div class="w-[100%]">
                                        ...
                                        <input class="rounded-[20px] w-full h-[50px] bg-[#E7E7E7]" type="text"
                                            ...
                                            name="maSp" value="<?php echo isset($row['maSp']) ? $row['maSp'] : ''; ?>"
                                            readonly><br><br>
                                    </div>
                                ...
                                <div class="flex mt-[10px]">
                                    <div class="w-[70%]">
                                        ...
                                        <input class="rounded-[20px] w-full h-[50px] bg-[#E7E7E7]" type="text"
                                            style="padding-left: 20px " name="tenSp"
                                            value="<?php echo $row['tenSp']; ?>"><br><br>
                                    </div>
                                    <div class="w-[30%] ml-[20px]">
                                        ...
                                        <input class="rounded-[20px] w-full h-[50px] bg-[#E7E7E7]" type=" number"
                                            ...
                                            value="<?php echo $row['soLuong']; ?>"><br><br>
                                    </div>
                                </div>
                                ...
                                <div class="flex mt-[10px]">
                                    <div class="w-[30%]">
                                        ...
                                        <input class="rounded-[20px] w-full h-[50px] bg-[#E7E7E7]" type="text"
                                            ...
                                            value="<?php echo $row['theLoai']; ?>"><br><br>
                                    </div>
                                    <div class="w-[70%] ml-[20px]">
                                        <label class="block font-semibold">Tác giả:</label>
                                        <input class="rounded-[20px] w-full h-[50px] bg-[#E7E7E7]" type="text"
                                            style="padding-left: 20px " name="tacGia"
                                            value="<?php echo $row['tacGia']; ?>"><br><br>
                                    </div>

                                </div>
                                <div class="flex justify-center w-full mt-[20px]">
                                    <input
                                        style="background-color: #3252DF; border-radius: 20px; width: 50%; height: 50px; font-weight: bold; font-size: 18px; color: white;"
                                        type="submit" value="Cập nhật" name="updateBook">
                                </div>
                ...
                echo "<script>alert('Không tìm thấy sách có mã SP!');</script>";
